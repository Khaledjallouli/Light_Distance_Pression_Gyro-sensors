#include "main.h"
//====================================================================
#define VL6180X	1// à 1
#define MPU9250	0
#define MPL115A_ANEMO 0 // à 0
//====================================================================
...
int main(void)
{
    ...
    while (1) {
        ...
        luxMsg.id=0x69;
        luxMsg.data[0]='L';
        luxMsg.data[1]=Als.lux;
        luxMsg.data[2]=Als.lux<<8;
        luxMsg.data[3]=Als.lux<<16;
        luxMsg.data[4]=Als.lux<<24;


        luxMsg.len=5;
        luxMsg.format=CANStandard;
        luxMsg.type=CANData;
    	...
    	distMsg.id=0x78;
    	distMsg.data[0]='D';
    	distMsg.data[1]=range;
    	distMsg.data[2]=range<<8;
    	distMsg.data[3]=range<<16;
    	distMsg.data[4]=range<<24;

    	distMsg.len=5;
    	distMsg.format=CANStandard;
    	distMsg.type=CANData;
...
void VL6180x_Step(void)
{
    ...
    //new_switch_state = XNUCLEO6180XA1_GetSwitch(); avec la bouton rouge
    new_switch_state = txMsg.data[0] ;
